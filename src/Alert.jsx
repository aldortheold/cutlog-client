...
export default function Alert({ ref, type, message, margin }) {
    return (
        <dialog closedby="any" className={`alert ${type}`} ref={ref} style={{ marginTop: margin }}>
            <div>
                <p>{message}</p>
                <button onClick={() => closeModal(ref)}>
